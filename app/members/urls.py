...
from .views import login, logout, signup, user_list, modify, email_check, likes_rooms, change_password
...
urlpatterns = [
    ...
    path('profile/password/', change_password.ChangePassword.as_view(), name='change-password'),
